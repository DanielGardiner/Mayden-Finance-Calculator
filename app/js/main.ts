...
function roundDownAddCommas(x: number): string {
    let xString: string

    if (x < 0.01) {
        // console.log('less than 0.01')
        xString = x.toPrecision(1)
    } else {
        // console.log('greater than 0.01')
        // console.log(parseInt(x.toFixed(2))
        xString = x.toFixed(2)
    }
